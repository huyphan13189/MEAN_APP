...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            ...
            console.log("================> User profile: " + JSON.stringify(_this.user));
        }, function (err) {
            console.log(err);
            return false;
        });
...
var LoginComponent = (function () {
    function LoginComponent(authService, router, flasMassageService) {
        this.authService = authService;
        this.router = router;
        this.flasMassageService = flasMassageService;
    }
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flasMassageService.show('You are logged in', { cssClass: 'alert-success', timeout: 5000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flasMassageService.show(data.msg, { cssClass: 'alert-danger', timeout: 5000 });
                _this.router.navigate(['/login']);
            }
        });
    };
...
var NavbarComponent = (function () {
    function NavbarComponent(authService, router, flasMassageService) {
        this.authService = authService;
        this.router = router;
        this.flasMassageService = flasMassageService;
    }
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flasMassageService.show('You are logged out', { cssClass: 'alert-success', timeout: 10000 });
        this.router.navigate(['/login']);
    };
    NavbarComponent.prototype.display = function () {
        return false;
    };
